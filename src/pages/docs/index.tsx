  ...
  return (
    <DocsLayout title="Setup">
      ...
      <Figure img="/images/docs/Fig.12.png" title="fig 12">
        <p className="pt-4 pb-16">
          Give your token a name, e.g. <CodeInline>NIIIFTY Tutorial</CodeInline>{" "}
          and click <strong>Create</strong>.<br />
      ...
      <Figure img="/images/docs/Fig.14.png" title="fig 14">
        <p className="pt-4 pb-16">
          In your firebase console, click the cog icon next to{" "}
          <strong>Project Overview</strong> and select{" "}
          <strong>Project settings</strong>.<br /> Under the{" "}
      ...
      <Figure img="/images/docs/Fig.19.png" title="fig 19">
        <p className="pt-4 pb-16">
          ...
          <CodeInline>niiifty-tutorial</CodeInline> (or another name of your
          choice). <br />
      ...
      <Figure img="/images/docs/Fig.20.png" title="fig 20">
        <p className="pt-4 pb-16">
          ...
          Add your vercel project domain, e.g.{" "}
          <CodeInline>niiifty-tutorial.vercel.app</CodeInline> (this can be
          found on your vercel project dashboard).
        </p>
      </Figure>
      ...
      <Figure img="/images/docs/Fig.25.png" title="fig 25">
        <p className="pt-4 pb-16">
          ...
          <CodeInline>niiifty-tutorial.appspot.com</CodeInline>
        </p>
      </Figure>
...
gsutil cors set cors.json [gsUtil]`}</CodeBlock>
      ...
      <p>
        ...
        <CodeInline>https://niiifty-tutorial.vercel.app</CodeInline> you will be
        able to create an account associated with your Gmail address and start
        uploading files!
      </p>
    </DocsLayout>
  );
