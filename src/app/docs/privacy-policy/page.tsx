    ...
    <DocsLayout title="Privacy Policy">
      <>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              &quot;Our&quot; in this Agreement) refers to Mnemoscene Ltd, 34 Cambridge Road, Hove, UK, BN3 1DF.
            </p>
          ...
          <li>
            <p>
              ...
              <a href="https://niiifty.com" rel="nofollow noopener" target="_blank">
                https://niiifty.com
              </a>
            </p>
          </li>
        ...
        <p>
          ...
          <a href="https://www.termsfeed.com/blog/cookies/" rel="external noopener noreferrer" target="_blank">
            All About Cookies
          </a>
          .
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>Performance of a contract:</strong> Provision of Personal Data is necessary for the performance of
        ...
        <ul>
          ...
          <li>
            <strong>Request correction of the Personal Data that We hold about You.</strong> You have the right to to
        ...
        <ul>
          <li>
            <strong>The right to notice.</strong> You must be properly notified which categories of Personal Data are
            being collected and the purposes for which the Personal Data is being used.
          </li>
          <li>
            <strong>The right to access / the right to request.</strong> The CCPA permits You to request and obtain from
          ...
          <li>
            <strong>The right to say no to the sale of Personal Data.</strong> You also have the right to ask the
            Company not to sell Your Personal Data to third parties. You can submit such a request by visiting our
            &quot;Do Not Sell My Personal Information&quot; section or web page.
          </li>
          <li>
            <strong>The right to know about Your Personal Data.</strong> You have the right to request and obtain from
          ...
          <li>
            <strong>The right to delete Personal Data.</strong> You also have the right to request the deletion of Your
            Personal Data that have been collected in the past 12 months.
          </li>
          <li>
            <strong>The right not to be discriminated against.</strong> You have the right not to be discriminated
        ...
        <p>
          The Company may collect and store the following types of personal information about a child when submitted by
          a child with prior parental consent or by the parent or guardian of the child:
        </p>
        <ul>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              <a href="https://niiifty.com/contact" rel="external nofollow noopener" target="_blank">
