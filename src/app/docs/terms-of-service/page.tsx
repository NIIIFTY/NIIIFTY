    ...
    <DocsLayout title="Terms of Service">
      <>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              &quot;Our&quot; in this Agreement) refers to Mnemoscene Ltd, 34 Cambridge Road, Hove, BN3 1DF.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              <a href="https://niiifty.com" rel="external nofollow noopener" target="_blank">
                https://niiifty.com
              </a>
            </p>
          </li>
        ...
        <p>
          ...
          or revoke the use of the Service if You post such objectionable Content. As the Company cannot control all
          content posted by users and/or third parties on the Service, you agree to use the Service at your own risk.
          You understand that by using the Service You may be exposed to content that You may find offensive, indecent,
          incorrect or objectionable, and You agree that under no circumstances will the Company be liable in any way
          for any content, including any errors or omissions in any content, or any loss or damage of any kind incurred
        ...
        <p>
          ...
          must submit Your notice in writing to the attention of our copyright agent via email at {t('email')} and
        ...
        <p>
          You can contact our copyright agent via email at {t('email')}. Upon receipt of a notification, the Company
